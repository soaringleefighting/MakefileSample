...
// 函数指针的声明
void (*transpose)(unsigned char *dst, unsigned char *src, int width_lowres, int stride_lowres, int lines_lowres);
...
// arm neon初始化
void transpose_init_arm(unsigned char *dst, unsigned char *src, int width_lowres, int stride_lowres, int lines_lowres);
