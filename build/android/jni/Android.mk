...
LOCAL_LDFLAGS := $(LOCAL_PATH)/../out/$(TARGET_ARCH_ABI)/libAVSample.a
LOCAL_LDFLAGS += -pie -fPIE
#LOCAL_STATIC_LIBRARIES := $(LOCAL_PATH)/../out/$(TARGET_ARCH_ABI)/libAVSample.a

#设置demo源文件
SRC_DIR =$(LOCAL_PATH)/../../../demo
DEMO_SRCS := $(SRC_DIR)/demo.c
DEMO_SRCS += $(SRC_DIR)/os_time_sdk.c
